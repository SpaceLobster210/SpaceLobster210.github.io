...
Hello! I am an indie game developer & musician, currently studying computer science at the University of Alberta. I love making stuff--whether that's games, music, art, simulations, or something else entirely. This page is a collection of my notable works.
...
Star Apprentice: Dazzling Danmaku Detective (Role: musician and various other tasks)
<iframe src="https://store.steampowered.com/widget/2388860/" frameborder="0" width="646" height="190"></iframe>

Iron Wild (Role: musician/audio and programmer)
...
Cowboy.exe (working title) (Role: musician)
[Cowboy.exe Devlog - Milk Man Steve](https://www.youtube.com/watch?v=0jTI8UfcY1M)

Get Out - U of A Games Den Telephone Jam 2025 (Role: musician/audio, art, programming, level design)
This video details a level I designed, a music track I created for the project, some art assets I created (the attack animation, enemies, and greenery), and some programming work (player's attack and the enemy shown at the end).
(The telephone jam is a game that gets passed around between different developers with little to no communication between them. I was the second person given access to this game and had a week to add some assets to the project)
...
The game sends data via OSC signals to a synthesizer I built in VCV Rack as part of the project, synthesizing audio in real time based on what happens in the gane.
The game was set up as an interactive installation/kiosk at our class's Electronic Music festival in early 2025.
(I apologize for the weird video cropping, there was an issue recording it. I will try to set it back up and get a better recording in the future)
<iframe width="560" height="315" src="https://www.youtube.com/embed/GCo3i9Hqwkk?si=LntCvZVWKQHrgjx8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>


## Music

Some of my favourite tracks I have composed for various projects
...
Personalize
An interactive music installation I built in Max MSP over 2 weeks for an interactive audio systems class at the University of Alberta (MUSIC 545).
I built a simple AI inside of this music software that trains itself on the user's actions in order to slowly "gain sentience" and interfere with the control interface.
I added additional visual elements such as "popups" and the flashing smile as well as audio elements such as sound effects, modulations, and stingers in order to create a dynamic experience where the user constantly feels as though things are happening around them.
...
This project uses 4-channel audio to emulate a 3D environment around the user and make it feel as though things are happening all around them.

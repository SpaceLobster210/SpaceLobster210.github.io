...
<p>Cowboy.exe (working title) (Role: musician)</p>
[Cowboy.exe Devlog - Milk Man Steve](https://www.youtube.com/watch?v=0jTI8UfcY1M)

<p><br>Get Out - U of A Games Den Telephone Jam 2025 (Role: musician/audio, art, programming, level design)<br>
This video details a level I designed, a music track I created for the project, some art assets I created (the attack animation, enemies, and greenery), and some programming work (player's attack and the enemy shown at the end).<br>
